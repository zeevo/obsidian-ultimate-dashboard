	...
	overrides: [
		{
			 ...
			 */
			files: ["src/config.ts", "src/store.ts", "src/ics.ts", "src/data.ts", "src/google.ts", "src/kinds.ts", "src/schema.ts", "src/widgets.ts", "src/serialize.ts", "src/widget-form.ts", "src/layout-tree.ts"],
			rules: {
